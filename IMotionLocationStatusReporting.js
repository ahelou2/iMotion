 ...
 * @providesModule IMotionLocationStatusReporting
 */


import React, { Component } from 'react';
import { ScrollView, AppRegistry, StyleSheet, Text, View, DeviceEventEmitter, Linking, Dimensions, TouchableHighlight } from 'react-native'
...
class IMotionLocationStatusReporting extends Component {
          ...
          <View style={{alignItems:'flex-start'}}>
            ...
            <View style={{margin:10}}>
            {
                ...
                this.state.beacons.map((beacon, idx) => {
                  let nonZeroIdx = idx + 1;
                 return (<View style={{flex: 1}} key={beacon.id}>
...
module.exports = IMotionLocationStatusReporting;
